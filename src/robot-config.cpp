...
motor ExpansionMotor = motor(PORT9, ratio18_1, true);
...
motor IntakeMotorsMotorA = motor(PORT10, ratio18_1, false);
motor IntakeMotorsMotorB = motor(PORT20, ratio18_1, false);
